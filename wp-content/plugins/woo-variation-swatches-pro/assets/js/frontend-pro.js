        ...
        Promise.resolve()
          ...
          .then(function () {
            $(document).on(
              ...
              ".variations_form:not(.wvs-pro-loaded)",
              function (event, form) {
      ...
      var WooVariationSwatchesPro = (function ($) {
        ...
        var WooVariationSwatchesPro = (function () {
          function WooVariationSwatchesPro(element, config) {
            ...
            this.is_loop = this._element.hasClass(
            ...
            this._wrapper = this._element.closest(
              woo_variation_swatches_options.archive_product_wrapper
            );
            ...
            this._image = this._wrapper.find(
              woo_variation_swatches_options.archive_image_selector
            );
            ...
            this._resetVariations = this._element.find(
              ".woo_variation_swatches_archive_reset_variations"
            );
            this.is_mobile = $("body").hasClass(
              "woo-variation-swatches-on-mobile"
            );
            // Iconic Woothumbs Support
            this.iconic_woothumbs_all_images_wrap = $(
              ".iconic-woothumbs-all-images-wrap"
            );
            this.iconic_woothumbs_show_variation_trigger =
              "iconic_woothumbs_show_variation";

            if (
              woo_variation_swatches_options.archive_cart_button_selector.trim()
            ) {
              this._cart_button = this._wrapper.find(
                woo_variation_swatches_options.archive_cart_button_selector
              );
              this._cart_button_ajax = this._wrapper.find(
                woo_variation_swatches_options.archive_cart_button_selector
              );
            ...
            [
              {
                ...
                value: function init() {
                  ...
                  this._element.trigger("woo_variation_swatches_pro_init", [
                    this,
                    this.product_variations,
                  ]);
                  $(document).trigger("woo_variation_swatches_pro_loaded", [
                    this._element,
                    this.product_variations,
                  ]);
                },
              },
              {
                ...
                value: function variationImagePreview() {
                  var preview_attribute =
                    woo_variation_swatches_options.single_variation_preview_attribute;

                  if (
                    this.is_single_product &&
                    woo_variation_swatches_options.enable_single_variation_preview &&
                    woo_variation_swatches_options.single_variation_preview_attribute
                  ) {
                    this._attributeFieldSingle = this._element.find(
                      ".variations select#" + preview_attribute
                    );
                  ...
                  if (
                    this.is_loop &&
                    woo_variation_swatches_options.enable_single_variation_preview_archive &&
                    woo_variation_swatches_options.enable_single_variation_preview &&
                    woo_variation_swatches_options.single_variation_preview_attribute
                  ) {
                    var archiveAttribute = this._element
                      .data("single_variation_preview_attribute")
                      .trim();

                    preview_attribute = archiveAttribute
                      ? archiveAttribute
                      : preview_attribute;
              ...
              },
              {
                ...
                value: function clickableVariationURL() {
                  if (
                    this.is_single_product &&
                    woo_variation_swatches_options.enable_linkable_variation_url
                  ) {
                ...
                value: function generateVariationURL() {
                  ...
                  this._element.on(
                    ...
                    function (event) {
                      ...
                      var attributesObject = Object.keys(attributes).reduce(
                        function (attrs, current) {
                      ...
                      var searchObject = []
                        .concat(
                          _toConsumableArray(new URLSearchParams(search).keys())
                        )
                        .reduce(function (attrs, current) {
                          attrs[current] = new URLSearchParams(search).get(
                            current
                          );
                          return attrs;
                        }, {});
                      ...
                      window.history.pushState(
                        {},
                        "",
                        _this2.addQueryArg(originalUrl, params)
                      );
                    }
                  );
                },
              },
              {
                ...
                value: function setDefaultTemplate() {
                  ...
                  var product_variations =
                    this._element.data("product_variations");
                  ...
                  if (
                    ...
                    var matching_variations = this.findMatchingVariations(
                      product_variations,
                      currentAttributes
                    );
                    ...
                    if (variation) {
                      ...
                      console.error(
                        "Default Product variation not available on product id " +
                          this._product_id
                      );
                    }
                  }
              ...
              },
              {
                ...
                value: function archiveCatalogHoverEvent() {
                  ...
                  this._element
                    .find(
                      "ul.variable-items-wrapper.wvs-catalog-variable-wrapper > li:not(.disabled):not(.woo-variation-swatches-variable-item-more)"
                    )
                    .each(function (i, el) {
                      ...
                      if (
                        woo_variation_swatches_options.catalog_mode_event ===
                        "hover"
                      ) {
                        $(this).on(
                          "mouseenter.catalog-image-hover",
                          function (event) {
              ...
              },
              {
                ...
                value: function archiveEvents() {
                  ...
                  this._element.on(
                    "wvs_single_attribute_chosen.wvs",
                    function (event, variation) {
                      _this3.archiveImageUpdate(variation);
                    }
                  );
                ...
                value: function archiveTemplateReset() {
                  ...
                  if (!woo_variation_swatches_options.enable_catalog_mode) {
                    ...
                    if (this._cart_button.length > 0) {
                      ...
                      this._cart_button.attr(
                        "aria-label",
                        this._cart_button.data("select-options-aria-label")
                      );
                      this._cart_button.html(
                        this._cart_button.data("select-options")
                      );
                    ...
                    this._wrapper
                      .find(".added_to_cart, .added_to_cart_button")
                      .remove();
                  }
                },
              },
              {
                ...
                value: function archiveTemplateUpdate(variation) {
                  ...
                  var $template_html = template({
                    variation: variation,
                    price_html:
                      $(variation.price_html).unwrap().html() ||
                      this._price_html,
                  });
                  ...
                  if (!woo_variation_swatches_options.enable_catalog_mode) {
                    if (this._cart_button.length > 0) {
                      ...
                      this._cart_button.attr(
                        "aria-label",
                        this._cart_button.data("add-to-cart-aria-label")
                      );
                      this._cart_button.html(
                        this._cart_button.data("add-to-cart")
                      );
                      this._cart_button.removeClass("added");
                      ...
                      if (
                        ...
                        var params = $.param(
                          _extends({}, this.getChosenAttributes(), {
                        ...
                        this._cart_button.prop(
                          "href",
                          this.addQueryArg(
                            this._cart_button.data("add_to_cart_url"),
                            params
                          )
                        );
                      }
          ...
          $(this).removeClass('wvs-pro-image-load')
                  ...
                  if (
                    ...
                    this._image.wc_set_variation_attr(
                      "src",
                      variation.image.thumb_src
                    );
                    this._image.wc_set_variation_attr(
              ...
              },
              {
                ...
                value: function changeSingleAttributeImage() {
                  ...
                  var reset_data_callback = jQuery.extend(
                    true,
                    {},
                    events["reset_data"]
                  );
                  ...
                  this._attributeFieldSingle.on("change.wvs", function (event) {
                    ...
                    if (attributes.count > 0) {
                      if (
                        ...
                        allAttributes.chosenCount === 1
                      ) {
                        var variationData =
                          _this4._element.data("product_variations");
                        var matching_variations = _this4.findMatchingVariations(
                          variationData,
                          currentAttributes
                        );
                        var variation = matching_variations.shift();
                        ...
                        if (variation) {
                          ...
                          _this4._element.trigger(
                            "wvs_pro_single_preview_found_variation",
                            [_this4, variation]
                          );
                          _this4._element.trigger(
                            "wvs_single_attribute_chosen",
                            [variation, _this4]
                          );
                          ...
                          _this4._element.trigger(
                            woo_variation_swatches_options.single_variation_preview_js_event,
                            [variation, false]
                          );
              ...
              },
              {
                ...
                value: function findStockLabelVariation(
                  allVariations,
                  selectedAttributes
                ) {
                  var found = [];
                  ...
                  try {
                    for (
                      var _iterator = Object.entries(selectedAttributes.data)[
                          Symbol.iterator
                        ](),
                        _step;
                      ...
                      if (attribute_value.length === 0) {
                        var values =
                          this._element
                            .find(
                              "ul[data-attribute_name='" + attribute_name + "']"
                            )
              ...
              },
              {
                ...
                value: function showStockLabel() {
                  ...
                  if (
                    this.is_single_product &&
                    woo_variation_swatches_options.show_variation_stock_info
                  ) {
                    this._element.off("wvs-selected-item.wc-variation-form");
                    this._element.off("reset_data.wvs");

                    var max_stock_label = parseInt(
                      woo_variation_swatches_options.stock_label_display_threshold
                    );
                    ...
                    this._element.on(
                      "wvs-selected-item.wc-variation-form",
                      "li.variable-item:not(.radio-variable-item):not(.woo-variation-swatches-variable-item-more)",
                      function (event) {
                        ...
                        if (
                          ...
                          var variationData = _this5.findStockLabelVariation(
                            variations,
                            attributes
                          );

                          variationData.forEach(function (data) {
                            var stockInfoSelector =
                              '[data-attribute_name="' +
                              data.attribute_name +
                              '"] > [data-value="' +
                            ...
                            if (
                              ...
                              data.variation.wvs_stock_left &&
                              data.variation.max_qty <= max_stock_label
                            ) {
                              _this5._element
                                .find(
                                  stockInfoSelector + " .wvs-stock-left-info"
                                )
                                .attr(
                                  "data-wvs-stock-info",
                                  data.variation.wvs_stock_left
        ...
        $.fn["WooVariationSwatchesPro"] =
          WooVariationSwatchesPro._jQueryInterface;
