            ...
            [
              ...
              },
              {
                ...
                value: function archiveTemplateReset() {
                  ...
                  if (!woo_variation_swatches_options.enable_catalog_mode) {
                    ...
                    this._wrapper
                      .find(".price")
                      .html(this._price_html + "sssssssssssssss");
                    this._wrapper
              ...
              },
              {
                ...
                value: function archiveTemplateUpdate(variation) {
                  ...
                  /* ticket price calc start */

                  var productPrice = variation.display_price;
                  var tickets = Math.trunc(productPrice / 20);
                  console.log(tickets);

                  this._wrapper.find(".tickets").html(tickets + " ticket");

                  if (tickets > 1) {
                    this._wrapper.find(".tickets").html(tickets + " tickets");
                  }

                  /* ticket price calc end */
