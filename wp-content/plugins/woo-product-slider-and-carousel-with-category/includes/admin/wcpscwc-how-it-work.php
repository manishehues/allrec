							...
							<div class="wpos-col">
								<div class="wpos-box">
									...
									<ul class="wpos-list">
										...
										<li><a href="<?php echo WCPSCW_PLUGIN_LINK_UPGRADE; ?>" target="_blank">View More All Features</a></li>
									</ul>
									<div style="text-align:center;">
										<a class="button button-primary button-blue" href="<?php echo WCPSCW_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php _e('Grab Now', 'woo-product-slider-and-carousel-with-category'); ?></a>
									</div>
								</div>
							</div>
							<div class="wpos-col">
								<div class="wpos-box">
									...
									<div style="text-align:center;">
										<a class="button button-primary button-orange" href="<?php echo WCPSCW_PLUGIN_BUNDLE_LINK; ?>" target="_blank"><?php _e('Grab Now', 'woo-product-slider-and-carousel-with-category'); ?></a>
									</div>
								</div>
							</div>
				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo WCPSCW_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php _e('Grab Product Slider/Carousel Now', 'woo-product-slider-and-carousel-with-category'); ?></a>
						</div>
					</div>
				</div>
			</div>
