...
<div class="wrap">
	...
	<h2><?php _e( 'Product Slider and Carousel with Category for WooCommerce with ', 'woo-product-slider-and-carousel-with-category' ); ?><span class="h-blue"><?php _e( 'Essential Plugin Bundle', 'timeline-and-history-slider' ); ?></span></h2>
	...
	<div id="poststuff">
		<div id="post-body" class="metabox-holder columns-2">
			<div id="post-body-content">
				<h3 class="larger-font"><?php _e( 'Well <span style="color:#388e3c"> optimized</span>, <span style="color:#7b1fa2">light weight</span> & <span style="color:#3e50b4">expandable</span> plugins <br /> for <span style="background:#ff4081; color:#fff;">web site, landing pages &amp; conversions</span>', 'woo-product-slider-and-carousel-with-category' ); ?></h3>
				<h3 class=""><?php _e( 'Multiple pre-built template options with <span class="h-orange"> Gutenberg, DIVI, Elementor, Avada, VC/WPbakery </span>etc page builder/themes', 'woo-product-slider-and-carousel-with-category' ); ?></h3>
				<h3 class="larger-font"><?php _e( '<span class="h-blue">46 plugins</span>, <span class="h-blue">10 sliders</span> with <span class="h-blue">2000+</span> pre-built templates in <span class="h-blue">Essential Bundle</span>', 'woo-product-slider-and-carousel-with-category' ); ?></h3>
				<h3 style="text-align:center;"><?php _e( 'Top plugins category wise:', 'woo-product-slider-and-carousel-with-category' ); ?></h3>
						...
						<tr>
							<td>
								...
								<div class="wp-plugin-icon">
									<img src="<?php echo WCPSCWC_URL; ?>assets/images/utility-50.png" width="26">
									<img src="<?php echo WCPSCWC_URL; ?>assets/images/security-icon.png" width="26">
								</div>
							</td>
							<td>
								<ul>
								...
								<div class="wp-plugin-icon">
									<img src="<?php echo WCPSCWC_URL; ?>assets/images/utility-50.png" width="26">
									<img src="<?php echo WCPSCWC_URL; ?>assets/images/inboundwp-50.png" width="26">
								</div>
							</td>
							<td>
								<ul>
								...
								<div class="wp-plugin-icon">
									<img src="<?php echo WCPSCWC_URL; ?>assets/images/utility-50.png" width="26">
									<img src="<?php echo WCPSCWC_URL; ?>assets/images/inboundwp-50.png" width="26">
									<img src="<?php echo WCPSCWC_URL; ?>assets/images/SlidersPack-50.png" width="26">
									<img src="<?php echo WCPSCWC_URL; ?>assets/images/security-icon.png" width="26">
								</div>
							</td>
						</tr>
				...
				<div class="wp-icons">
					<ul>
						<li><img src="<?php echo WCPSCWC_URL; ?>assets/images/utility-50.png" width="18"> - Utility Plugin (Total 39), </li>
						<li><img src="<?php echo WCPSCWC_URL; ?>assets/images/inboundwp-50.png" width="15">  -  Inbound Maketing (Total 6), </li>
						<li><img src="<?php echo WCPSCWC_URL; ?>assets/images/SlidersPack-50.png" width="16">  -  SlidersPack (Total 10), </li>
						<li><img src="<?php echo WCPSCWC_URL; ?>assets/images/security-icon.png" width="16">  -  Essnetial Security</li>
					</ul>
					<a class="epb-cutom-button" href="<?php echo WCPSCW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Woo-Product-Slider&utm_campaign=Upgrade-PRO-Top-Cat" target="_blank">Buy Now</a>
				</div>
