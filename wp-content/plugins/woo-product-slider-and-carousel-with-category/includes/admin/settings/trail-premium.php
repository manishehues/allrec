			...
			<div id="post-body-content">
				<div class="grid-x grid-padding-x">
					...
					<div class="small-12 medium-12 cell text-center section-space-medium">
						<a href="<?php echo WCPSCW_CHECKOUT_PLUGIN_LINK; ?>" class="large button button-orange radius" target="_blank">Join 0$ 14 Days Pro Trial</a>
					</div>
				</div>
				...
				<div class="text-center section-space-larger">
					<a href="<?php echo WCPSCW_CHECKOUT_PLUGIN_LINK; ?>" class="large button button-orange radius" target="_blank">Join 0$ 14 Days Pro Bundle Trial</a>
