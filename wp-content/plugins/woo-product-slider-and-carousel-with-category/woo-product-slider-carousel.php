...
if( ! defined( 'WCPSCWC_VERSION' ) ) {
	define( 'WCPSCWC_VERSION', '2.6.5' ); // Version of plugin
}
...
if( ! defined( 'WCPSCW_PLUGIN_BUNDLE_LINK' ) ) {
	define('WCPSCW_PLUGIN_BUNDLE_LINK','https://www.essentialplugin.com/wordpress-plugin/woo-product-slider-carousel-category/?utm_source=WP&utm_medium=Product-Slider&utm_campaign=Bundle-Banner#wpos-epb'); // Plugin link
}

if( ! defined( 'WCPSCW_PLUGIN_LINK_UNLOCK' ) ) {
	define('WCPSCW_PLUGIN_LINK_UNLOCK','https://www.essentialplugin.com/wordpress-plugin/woo-product-slider-carousel-category/?utm_source=WP&utm_medium=Product-Slider&utm_campaign=Features-PRO'); // Plugin link
}

if( ! defined( 'WCPSCW_PLUGIN_LINK_UPGRADE' ) ) {
	define('WCPSCW_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/wordpress-plugin/woo-product-slider-carousel-category/?utm_source=WP&utm_medium=Product-Slider&utm_campaign=Upgrade-PRO'); // Plugin Check link
}
