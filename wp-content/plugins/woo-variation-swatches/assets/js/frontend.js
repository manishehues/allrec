      ...
      jQuery(function ($) {
        Promise.resolve()
         ...
         $(self.$component_content).find('.variations_form').removeClass('wvs-loaded wvs-pro-loaded')
            ...
            $(".shop-container .products, .infinite-scroll-wrap").on(
            ...
            [
              {
                ...
                value: function init() {
                  ...
                  this._generated = this.product_variations.reduce(function (
                    ...
                    Object.keys(variation.attributes).map(function (
                      attribute_name
                    ) {
                  ...
                  this._out_of_stock = this.product_variations.reduce(function (
                    obj,
                    variation
                  ) {
                    Object.keys(variation.attributes).map(function (
                  ...
                  this.$element
                    ...
                    .each(function (i, el) {
                      ...
                      var $selected_variation_item = $(this)
                        .parent()
                        .prev()
                      ...
                      var available = _.difference(
                        in_stocks,
                        out_of_stock_selects
                      );
                      ...
                      li.each(function (index, li) {
                        ...
                        if (
                          available.length > 0 &&
                          _.includes(out_of_stock_selects, attribute_value) &&
