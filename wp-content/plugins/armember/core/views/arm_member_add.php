                        ...
                        <div id="arm_page_wrap">
                            ...
                            <div class="arm_admin_form_content">
                                <table class="form-table">
                                    ...
                                    <tr class="form-field">
                                        <th></th>
                                        <td><a class="arm_form_additional_btn" href="javascript:void(0);"><i></i><span><?php _e('Additional Fields', 'ARMember'); ?></span></a></td>
                                    </tr>
                                </table>
                    ...
                    <table class="form-table">
                        <tr>
                            <td colspan="2">
                                ...
                                <div class="page_sub_title"><?php _e('Membership Plan', 'ARMember'); ?></div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                        ...
                                        <li class="arm_user_plan_li_0 arm_margin_bottom_20">
                                            <div class="arm_user_plns_box">
                                                ...
                                                <dl class="arm_selectbox column_level_dd arm_member_form_dropdown arm_margin_right_5">
                                                    <dt><span></span><input type="text" style="display:none;" value="" class="arm_autocomplete" /><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                                    <dd>
                                                        <ul data-id="arm_user_plan_0"><?php echo $plansLists; ?></ul>
                                                    </dd>
                                                </dl>
                                        ...
                                        <div class="arm_confirm_box_body">
                                            ...
                                            <div class="arm_confirm_box_text arm_text_align_left arm_padding_top_15">
                                                ...
                                                <dl class="arm_selectbox column_level_dd arm_width_230">
                                                    <dt><span></span><input type="text" style="display:none;" value="" class="arm_autocomplete" /><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                                    <dd>
                                                        <ul data-id="arm_user_plan"><?php echo $plansLists; ?></ul>
                                                    </dd>
                                                </dl>
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <div class="arm_confirm_box arm_member_edit_confirm_box arm_confirm_box_extend_renewal_date" id="arm_confirm_box_extend_renewal_date_<?php echo $pID; ?>">
                                                                                    <div class="arm_confirm_box_body">
                                                                                        <div class="arm_confirm_box_arrow"></div>
                                                                                        <div class="arm_confirm_box_text arm_padding_top_15">
                                                                                            <span class="arm_font_size_15 arm_margin_bottom_5"> <?php _e('Select how many days you want to extend in current cycle?', 'ARMember'); ?></span>
                        ...
                        */
                        ?>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="arm_solid_divider"></div>
                                    <div class="page_sub_title"><?php _e('Paid Post', 'ARMember'); ?></div>
                                </td>
                            </tr>
                                        ...
                                        <li class="arm_user_plan_li_1 arm_margin_bottom_20">
                                            <div class="arm_user_plns_box">
                                                ...
                                                <dl class="arm_selectbox column_level_dd arm_member_form_dropdown arm_margin_right_5">
                                                    <dt><span></span><input type="text" style="display:none;" value="" class="arm_autocomplete" /><i class="armfa armfa-caret-down armfa-lg"></i></dt>
                                                    <dd>
                                                        <ul data-id="arm_user_post_1"><?php echo $paidPlansLists; ?></ul>
                                                    </dd>
                                                </dl>
                    ...
                    <?php if ($arm_social_feature->isSocialFeature) : ?>
                        ...
                        <table class="form-table">
                            <tr>
                                <td colspan="2">
                                    <div class="arm_solid_divider"></div>
                                    <div class="page_sub_title"><?php _e('Social Fields', 'ARMember'); ?></div>
                                </td>
                            </tr>
                            <tr class="form-field">
                                <th>
